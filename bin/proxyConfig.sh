...
configDomain() {
	echo       "Windows Domain:"
	read -p    "  Domain:      [${WINDOWS_DOMAIN_NEW}] "
	WINDOWS_DOMAIN_NEW=${REPLY:=$WINDOWS_DOMAIN_NEW}
	read -p    "  Realm:       [${WINDOWS_DOMAIN_REALM_NEW}] "
	WINDOWS_DOMAIN_REALM_NEW=${REPLY:=$WINDOWS_DOMAIN_REALM_NEW}
	read -p    "  Hostname:    [${WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW}] "
	WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW=${REPLY:=$WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW}
	read -p    "  IP Address:  [${WINDOWS_DOMAIN_CONTROLLER_IP_NEW}] "
	WINDOWS_DOMAIN_CONTROLLER_IP_NEW=${REPLY:=$WINDOWS_DOMAIN_CONTROLLER_IP_NEW}
	read -p    "  Username:    [${WINDOWS_DOMAIN_USERNAME_NEW}] "
	WINDOWS_DOMAIN_USERNAME_NEW=${REPLY:=$WINDOWS_DOMAIN_USERNAME_NEW}
	FAKE_PASSWORD_STR="********" ; [ -z "${WINDOWS_DOMAIN_PASSWORD_NEW}" ] && FAKE_PASSWORD_STR=""
	read -s -p "  Password:    [${FAKE_PASSWORD_STR}] "
	WINDOWS_DOMAIN_PASSWORD_NEW=${REPLY:=$WINDOWS_DOMAIN_PASSWORD_NEW}
	echo "" ; echo ""
}
...
readonly WINDOWS_DOMAIN=${WINDOWS_DOMAIN_NEW}
readonly WINDOWS_DOMAIN_REALM=${WINDOWS_DOMAIN_REALM_NEW}
readonly WINDOWS_DOMAIN_CONTROLLER_HOSTNAME=${WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW}
readonly WINDOWS_DOMAIN_CONTROLLER=${WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW}.${WINDOWS_DOMAIN_REALM_NEW}
readonly WINDOWS_DOMAIN_CONTROLLER_IP=${WINDOWS_DOMAIN_CONTROLLER_IP_NEW}
readonly WINDOWS_DOMAIN_USERNAME=${WINDOWS_DOMAIN_USERNAME_NEW}
readonly WINDOWS_DOMAIN_PASSWORD=${WINDOWS_DOMAIN_PASSWORD_NEW}
...
WINDOWS_DOMAIN_NEW=${WINDOWS_DOMAIN}
WINDOWS_DOMAIN_REALM_NEW=${WINDOWS_DOMAIN_REALM}
WINDOWS_DOMAIN_CONTROLLER_HOSTNAME_NEW=${WINDOWS_DOMAIN_CONTROLLER_HOSTNAME}
WINDOWS_DOMAIN_CONTROLLER_NEW=${WINDOWS_DOMAIN_CONTROLLER_HOSTNAME}.${WINDOWS_DOMAIN_REALM}
WINDOWS_DOMAIN_CONTROLLER_IP_NEW=${WINDOWS_DOMAIN_CONTROLLER_IP}
WINDOWS_DOMAIN_USERNAME_NEW=${WINDOWS_DOMAIN_USERNAME}
WINDOWS_DOMAIN_PASSWORD_NEW=${WINDOWS_DOMAIN_PASSWORD}
